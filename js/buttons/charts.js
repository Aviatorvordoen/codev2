...
window.onload = () => {
    ...
    if (localStorage.getItem('THEME') == 1){
        // set light mode
        LIGHT_THEME_SW.classList.add("light_theme")
        LIGHT_THEME_SW.classList.add("light_theme_active")
        LIGHT_THEME_SW.classList.remove("theme_button")
        SETTINGS_CINTAUNER.classList.remove("settings_container_dark")
    }
    else{
        // set dark mode
        LIGHT_THEME_SW.classList.add("light_theme")
        LIGHT_THEME_SW.classList.add("theme_button")
        LIGHT_THEME_SW.classList.remove("light_theme_active")
        DARK_THEME_SW.classList.add('dark_theme_active')
        // DARK_THEME_SW.classList.add('dark_theme_active theme_button')
        SETTINGS_CINTAUNER.classList.add('settings_container_dark')
        SETTINGS_DIV_TITLE.classList.add('text_dark_theme')
        // hints.classList.add('hint_light')
        hints.forEach(hint=>{
            hint.classList.add('hint_light')
        })

        CUSTOM_THEME_BTNS.forEach(custom_theme_buttons=>{
            custom_theme_buttons.classList.add('theme_button')
        })
    }
...
const SETTINGS_CINTAUNER = document.querySelector('.settings_container')

// get title settigs div
const SETTINGS_DIV_TITLE = document.getElementById('set_t')
...
const CUSTOM_THEME_BTNS = document.querySelectorAll('.custom_theme')
// valid checkbox: is checked?
const HIDDEN_CHECKBOX = document.querySelector("#sdb")
...
function Change_theme_to_light()
{
    ...
    DARK_THEME_SW.classList.add('theme_button')
}
